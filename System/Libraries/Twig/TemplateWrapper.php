 ...
 */
final class System_Libraries_Twig_TemplateWrapper
{
	 ...
	 * directly (use System_Libraries_Twig_Environment::load() instead).
	 *
	 * @internal
	 */
	public function __construct(System_Libraries_Twig_Environment $env, System_Libraries_Twig_Template $template)
	{
		$this->env = $env;
