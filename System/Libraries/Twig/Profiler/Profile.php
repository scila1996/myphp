 ...
 * @final
 */
class System_Libraries_Twig_Profiler_Profile implements IteratorAggregate, Serializable
{
	...
	public function addProfile(System_Libraries_Twig_Profiler_Profile $profile)
	{
