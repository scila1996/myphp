...
class System_Libraries_Twig_Node_Expression_GetAttr extends System_Libraries_Twig_Node_Expression
{

	public function __construct(System_Libraries_Twig_Node_Expression $node, System_Libraries_Twig_Node_Expression $attribute, System_Libraries_Twig_Node_Expression $arguments = null, $type, $lineno)
	{
	...
	public function compile(System_Libraries_Twig_Compiler $compiler)
	{
		...
		$needSecond = $needThird || System_Libraries_Twig_Template::ANY_CALL !== $this->getAttribute('type');
