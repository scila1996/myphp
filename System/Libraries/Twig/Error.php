 ...
 */
class System_Libraries_Twig_Error extends Exception
{
	 ...
	 * @param System_Libraries_Twig_Source|string|null $source   The source context where the error occurred
	...
	public function __construct($message, $lineno = -1, $source = null, Exception $previous = null)
	{
		...
		elseif (!$source instanceof System_Libraries_Twig_Source)
		{
	 ...
	 *
	 * @return System_Libraries_Twig_Source|null
	 */
	public function getSourceContext()
	{
		return $this->filename ? new System_Libraries_Twig_Source($this->sourceCode, $this->filename, $this->sourcePath) : null;
	}

	/**
	 * Sets the source context of the Twig template where the error occurred.
	 */
	public function setSourceContext(System_Libraries_Twig_Source $source = null)
	{
		if (null === $source)
		{
	...
	public function __call($method, $arguments)
	{
		...
		throw new BadMethodCallException(sprintf('Method "System_Libraries_Twig_Error::%s()" does not exist.', $method));
	}
	...
	protected function guessTemplateInfo()
	{
		...
		{
			if (isset($trace['object']) && $trace['object'] instanceof System_Libraries_Twig_Template && 'System_Libraries_Twig_Template' !== get_class($trace['object']))
			{
