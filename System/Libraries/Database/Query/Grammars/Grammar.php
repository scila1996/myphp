...
class Grammar extends BaseGrammar
{
    ...
    {
        return implode(' ', array_map(function ($join) use ($query) {
     ...
     *
     * @param  \System\Libraries\Database\Query\Builder
     * @param  array  $orders
     * @return array
     */
    protected function compileOrdersToArray(Builder $query, $orders)
    {
        return array_map(function ($order) {
            return !isset($order['sql']) ? (is_int($order['column']) ? $order['column'] : $this->wrap($order['column'])) . ' ' . $order['direction'] : $order['sql'];
        }, $orders);
    }
    ...
    {
        $bindingsWithoutJoin = Binding::except($bindings, 'join');

        return array_values(
                array_merge($bindings['join'], $values, Binding::flatten($bindingsWithoutJoin))
        );
    }
